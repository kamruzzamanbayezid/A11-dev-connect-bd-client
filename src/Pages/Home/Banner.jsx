            ...
            <div className="hero min-h-[70vh]" style={{ backgroundImage: 'url(https://i.ibb.co/vPsTN9t/pngtree-blue-technology-web-banner-image-122453.jpg)' }}>
                  ...
                  <div className="hero-content text-center text-neutral-content">
                        <div className="">
                              ...
                              <p className="mb-5 text-sm md:text-base w-full md:w- mx-auto text-slate-300">Welcome to our Job Seekers Platform! Find your perfect match in the tech world. Post job openings or apply for roles that match your expertise. Your next big career move starts here!</p>
